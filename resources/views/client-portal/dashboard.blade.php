...
<div class="mb-5">
    <h1 class="text-lg font-bold text-slate-800">Bonjour {{ $client->name }}</h1>
...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-5">
    ...
    <div class="bg-white rounded-xl shadow-sm p-4">
        ...
        <p class="text-sm font-bold text-slate-800 mt-1">{{ number_format($totalPurchases, 0, ',', ' ') }} FCFA</p>
    </div>

    <div class="bg-white rounded-xl shadow-sm p-4">
        <p class="text-xs text-slate-400">Crédit restant</p>
        <p class="text-sm font-bold text-red-500 mt-1">{{ number_format($creditUsed, 0, ',', ' ') }} FCFA</p>
    </div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-5">
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="px-4 py-3 border-b border-slate-50">
            ...
            <p class="text-xs font-bold text-slate-700 mt-1">{{ number_format($sale->total_amount, 0, ',', ' ') }} FCFA</p>
        </div>
        @empty
    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="px-4 py-3 border-b border-slate-50">
            ...
            <p class="text-xs text-slate-500 mt-1">{{ Str::limit($message->message, 90) }}</p>
