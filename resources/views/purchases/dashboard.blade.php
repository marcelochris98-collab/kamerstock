...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
    <div class="bg-white rounded-xl shadow-sm p-5">
        ...
        <p class="text-xl font-bold text-slate-800 mt-2">{{ number_format($totalPurchases, 0, ',', ' ') }} FCFA</p>
    </div>

    <div class="bg-white rounded-xl shadow-sm p-5">
        <p class="text-xs text-slate-400">Total payé</p>
        <p class="text-xl font-bold text-emerald-600 mt-2">{{ number_format($totalPaid, 0, ',', ' ') }} FCFA</p>
    </div>

    <div class="bg-white rounded-xl shadow-sm p-5">
        <p class="text-xs text-slate-400">Dette fournisseurs</p>
        <p class="text-xl font-bold text-red-500 mt-2">{{ number_format($totalDue, 0, ',', ' ') }} FCFA</p>
    </div>
</div>
