...
<div class="p-6 bg-slate-50 min-h-screen text-slate-800" x-data="planForm()">
    ...
    {{-- Header --}}
    <div class="mb-6">
        <p class="text-xs text-slate-400 font-medium">Plans d'Abonnement / Nouveau</p>
        <h1 class="text-xl font-bold text-slate-900 mt-1">Ajouter un Plan</h1>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white border border-slate-200 shadow-sm rounded-2xl p-6">
                    ...
                    <p class="text-xs text-slate-400 mb-3">Saisissez une fonctionnalité par ligne. Elles apparaîtront sous forme de liste à puces.</p>
                    <textarea name="features_text" rows="5" placeholder="Rapports de ventes avancés&#10;Support client 24h/7d&#10;Multi-magasin"
                        class="w-full bg-white border border-slate-300 rounded-xl px-3.5 py-2 text-xs text-slate-900 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"></textarea>
                </div>
