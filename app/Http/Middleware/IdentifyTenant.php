    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if ($tenant) {
            ...
            if (config('platform.tenancy_enabled', false)) {
                ...
                // Boutique en statut pending / préparation
                ...
                // Boutique en lecture seule — bloquer les écritures
                ...
                // On configure la DB tenant ICI, SANS bloc finally.
                // La connexion reste active pour toute la durée de la requête,
                // y compris pendant l'authentification Laravel (Auth::attempt).
        ...
        // ✅ PAS de bloc finally ici.
        // Avant : finally { $this->dbManager->switchToDefault(); } remettait la DB
        // par défaut AVANT que Laravel puisse authentifier l'utilisateur dans la
        // DB tenant — causant l'erreur "identifiants incorrects".
        return $next($request);
    }
}